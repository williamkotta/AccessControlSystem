...
7.Run the script http://localhost/AccessControlSystem (frontend)

8. For admin Panel http://localhost/AccessControlSystem/admin
...
username: architectwills@gmail.com
Password: willIAM123456789

handcrafted by wills